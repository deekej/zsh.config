# Generated by Powerlevel10k configuration wizard on 2024-03-22 at 10:30 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # ram                   # free RAM
    # swap                  # used swap
    # tod                   # todo items (https://github.com/todotxt/todo.txt-cli)
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=017
  ...
  if [[ ${EUID} == 0 ]]; then
    ...
    typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='<U+F0B1>'
  else
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=237
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=011
  ...
  typeset -g POWERLEVEL9K_TOOLBOX_BACKGROUND=214
